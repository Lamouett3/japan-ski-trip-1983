...
// === Présentation: Lire plus / Lire moins ===
(function(){
  const wrap = document.getElementById('presentation-more');
...
(function(){
  const wrap = document.getElementById('devis-more');
  const btn = document.getElementById('devis-more-btn');
  if (!wrap || !btn) return;
  let open = false;
  function set(openNow){
    open = openNow;
